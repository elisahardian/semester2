## PROGRAM MEMBUAT DATA DOKTER. DENGAN FUNGSI, DENGAN PARAMETER, PRIVATE
#membuat kelas
class Dokter:
    #membuat konstruktor
    ...
    def totalGaji(self, __gaji):
        return self.tunjangan(self.__gaji) + self.__gaji
#program utama
def main():
    ...
    print("Tunjangan\t: ", objDokter.tunjangan(objDokter.getGaji))
    print("Total Gaji\t: ", objDokter.totalGaji(objDokter.getGaji))
main()
